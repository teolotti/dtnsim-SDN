...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/meanBundlesInSDR"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"RandomNetwork_cgrfa_1x/results/results_random/0.2/METRIC=sdrBundleStored:timeavg-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true.txt",
"RandomNetwork_cgr_proactive_1x/results/results_random/0.2/METRIC=sdrBundleStored:timeavg-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false.txt",
"RandomNetwork_bruf_1x/results/results_random/0.2/METRIC=sdrBundleStored:timeavg-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false.txt",
"RandomNetwork_cgr1_1x/results/results_random/0.2/METRIC=sdrBundleStored:timeavg-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false.txt",
"RandomNetwork_cgr3_1x/results/results_random/0.2/METRIC=sdrBundleStored:timeavg-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false.txt",
]
