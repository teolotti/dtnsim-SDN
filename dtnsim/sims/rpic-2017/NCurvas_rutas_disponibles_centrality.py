...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/results_centrality/centrality_rutas_Disponibles.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/results/results_centrality"
FILE_PATHS_C1 = ["1.0/METRIC=availableRoutes:sum-DENSITY=1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=120.txt",
"0.5/METRIC=availableRoutes:sum-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt",
"0.1/METRIC=availableRoutes:sum-DENSITY=0.1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=10.txt"]

FILE_PATHS_C2 = ["1.0/METRIC=availableRoutes:sum-DENSITY=1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=120.txt",
"0.5/METRIC=availableRoutes:sum-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt",
"0.1/METRIC=availableRoutes:sum-DENSITY=0.1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=10.txt"]
