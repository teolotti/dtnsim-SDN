...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/results_random/random_pares_de_nodos_conectados.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/results/results_random"
FILE_PATHS_C1 = ["1.0/METRIC=pairsOfNodesWithAtLeastOneRoute:sum-DENSITY=1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=120.txt",
"0.5/METRIC=pairsOfNodesWithAtLeastOneRoute:sum-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt",
"0.1/METRIC=pairsOfNodesWithAtLeastOneRoute:sum-DENSITY=0.1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=10.txt"]

FILE_PATHS_C2 = ["1.0/METRIC=pairsOfNodesWithAtLeastOneRoute:sum-DENSITY=1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=120.txt",
"0.5/METRIC=pairsOfNodesWithAtLeastOneRoute:sum-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt",
"0.1/METRIC=pairsOfNodesWithAtLeastOneRoute:sum-DENSITY=0.1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=10.txt"]
...
Y_LABEL = "Pares de Nodos Conectados"
