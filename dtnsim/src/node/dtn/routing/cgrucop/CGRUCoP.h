...
#ifndef SRC_NODE_DTN_ROUTING_CGRUCOP_CGRUCOP_H_
#define SRC_NODE_DTN_ROUTING_CGRUCOP_CGRUCOP_H_
...
class CGRUCoP: public RoutingDeterministic
{
public:
	CGRUCoP(int eid, SdrModel * sdr, ContactPlan * contactPlan, bool printDebug, int max_copies, double probability_of_failure, int ts_duration, std::vector<int> ts_start_times, int numOfNodes, string pathPrefix, string pathPosfix);
	virtual ~CGRUCoP();
