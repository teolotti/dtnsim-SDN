			...
			VEndpoint **vpoint)
{
	...
	sap.endpointMetaEid.schemeName = (char *) MTAKE(metaEid.schemeNameLength + 1);
	...
	sap.endpointMetaEid.nss = (char *) MTAKE(metaEid.nssLength + 1);
	...
	*bpsapPtr = (BpSAP) MTAKE(sizeof(Sap));
	if (*bpsapPtr == NULL)
	{
