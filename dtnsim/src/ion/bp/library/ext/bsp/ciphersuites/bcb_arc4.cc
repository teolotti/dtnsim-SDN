...
//	sessionKey = (unsigned char *) MTAKE(*sessionKeyLen);
//	CHKNULL(sessionKey);
//
...
//
//	dataBuffer = (unsigned char *) MTAKE(BCB_ENCRYPTION_CHUNK_SIZE);
//	CHKERR(dataBuffer);
//
...
//	encryptedSessionKey = (unsigned char *) MTAKE(sessionKeyLen);
