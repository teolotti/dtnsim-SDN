...
//			}
//
//			asb.parmsData = (uint8_t *) MTAKE(asb.parmsLen);
...
//			}
//
//			asb.resultsData = (uint8_t *) MTAKE(asb.resultsLen);
...
//
//	temp = (unsigned char *) MTAKE(bufLen);
//	if (temp == NULL)
//	{
...
//
//
//	if ((key.contents = (uint8_t *) MTAKE(ReqBufLen)) == NULL)
//	{
...
//	 *********************************************************************/
//
//	if ((serializedAsb = (unsigned char *) MTAKE(*length)) == NULL)
//	{
