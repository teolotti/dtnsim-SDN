    ...
    for size in bundleSizes:
        for day in days:
            for t in typ:
                ...
                #data.append([success/sent, day, t, size, traffic])
...
def plotDelay():
    ...
    fig.suptitle("Scenario 1: Average Bundle Delay")
...
def plotDelivery():
    fig, axs = plt.subplots(1,3, sharey=True, figsize=(20, 5))
    fig.suptitle("Scenario 1: Bundle Delivery Ratio")
...
def plotComplexity():
    fig, axs = plt.subplots(1,3, sharey=False, figsize=(20, 5))
    fig.suptitle("Scenario 1: Average Routing Complexity at Data Relays")
...
def plotRouting():
    fig, axs = plt.subplots(1,3, sharey=False, figsize=(20, 5))
    fig.suptitle("Scenario 1: Average Routing Computation Time per Bundle at Data Relays")
...
def plotTable():
    fig, axs = plt.subplots(1,3, sharey=True, figsize=(20, 5))
    fig.suptitle("Scenario 1: Average Routing Table Size at Data Relays")
...
def plotRoutingPerMule():
    fig, axs = plt.subplots(1,3, sharey=False, figsize=(20, 5))
    fig.suptitle("Scenario 1: Average Routing Computation Time per Bundle at Data Relays - Comparison")
