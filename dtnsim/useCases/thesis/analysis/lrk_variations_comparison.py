...
'''
Comparing CGR with varations of LRK
...
def bundleDelay(type, distribution, size):
    ...
    for scenario in ["scenario2", "scenario3"]:
        for routing, routingDir in [("cgr", "cgr"), ("lrk", "irr/lrk/default"), ("lrk_relay", "irr/lrk/no_inter_relay")]:
            for day in ["1", "2", "3", "4"]:
...
def plotBundle(t):
    ...
    g = sns.scatterplot(y='result', x='days', data=delay.loc[delay["scenario"] == "scenario2"], style='routing', hue='routing', markers=['o', 'X', 'D'], s=80, ax=axs[0], palette=palette)
    ...
    g = sns.scatterplot(y='result', x='days', data=ratio.loc[ratio["scenario"] == "scenario2"], hue='routing', style='routing', markers=['o', 'X', 'D'], s=80, ax=axs[1], palette=palette)
    ...
    g = sns.scatterplot(y='result', x='days', data=delay.loc[delay["scenario"] == "scenario3"], style='routing', hue='routing', markers=['o', 'X', 'D'], s=80, ax=axs[2], palette=palette)
    g.set_ylabel("Avg. Bundle Delay [s]", size='x-large')
    g.xaxis.grid(False)
    g.sharey(axs[0])
    g.set(xlabel=None)
    ...
    g = sns.scatterplot(y='result', x='days', data=ratio.loc[ratio["scenario"] == "scenario3"], hue='routing', style='routing', markers=['o', 'X', 'D'], s=80, ax=axs[3], palette=palette)
    g.set_ylabel("Bundle Delivery Ratio", size='x-large')
    g.xaxis.grid(False)
    g.sharey(axs[1])
    g.set(xlabel=None)
    ...
    fig.legend(handles, ['CGR', 'LRK', 'LRK (no inter-relay)'], loc='lower center', ncol=3, fontsize='x-large')
...
def plotRouting(t):
    ...
    g = sns.lineplot(y='result', x='days', data=time.loc[time["scenario"] == "scenario2"], style='routing', hue='routing', markers=['o', 'X', 'D'], markersize=8, ax=axs[0], palette=palette)
    ...
    g = sns.scatterplot(y='result', x='days', data=table.loc[table["scenario"] == "scenario2"], hue='routing', style='routing', markers=['o', 'X', 'D'], s=80, ax=axs[1], palette=palette)
    g.set(yscale='log')
    g.set(xlabel=None)
    ...
    # Scenario 3
    axs[2].set_title("(b.1)", size='x-large')
    g = sns.lineplot(y='result', x='days', data=time.loc[time["scenario"] == "scenario3"], style='routing', hue='routing', markers=['o', 'X', 'D'], markersize=8, ax=axs[2], palette=palette)
    g.set(yscale='log', xlabel=None)
    g.set_ylabel("Routing Time / Bundle [μs]", size='x-large')
    g.xaxis.grid(False)
    #g.sharey(axs[0])
    ...
    axs[3].set_title("(b.2)", size='x-large')
    g = sns.scatterplot(y='result', x='days', data=table.loc[table["scenario"] == "scenario3"], hue='routing', style='routing', markers=['o', 'X', 'D'], s=80, ax=axs[3], palette=palette)
    g.set(yscale='log', xlabel=None)
    g.set_ylabel("Number of Routes", size='x-large')
    g.xaxis.grid(False)
    #g.sharey(axs[1])
