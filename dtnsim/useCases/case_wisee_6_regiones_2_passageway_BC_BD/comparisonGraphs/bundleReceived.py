...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/bundleReceived.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"case1/results/METRIC=appBundleReceived:count.txt",
"case2/results/METRIC=appBundleReceived:count.txt",
]
