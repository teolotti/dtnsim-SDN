...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"case0/results/METRIC=appBundleReceivedHops:mean.txt",
"case1/results/METRIC=appBundleReceivedHops:mean.txt",
"case2/results/METRIC=appBundleReceivedHops:mean.txt",
]
