...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/dijkstraCalls.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"case1/results/METRIC=routeCgrDijkstraCalls:sum.txt",
"case2/results/METRIC=routeCgrDijkstraCalls:sum.txt",
]
