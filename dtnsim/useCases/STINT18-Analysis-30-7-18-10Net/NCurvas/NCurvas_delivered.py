...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/deliveredBundles"
...
#"RandomNetwork_sprayAndWait_1x/results/results_random/0.2/METRIC=appBundleReceived:count-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false.txt",
#"RandomNetwork_sprayAndWait_4copies_1x/results/results_random/0.2/METRIC=appBundleReceived:count-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false.txt",
#"RandomNetwork_epidemic_1x/results/results_random/0.2/METRIC=appBundleReceived:count-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false.txt"
]
...
#DOTS = [0.0,0.1,0.2,0.10,0.4,0.2,0.6,0.7,0.8,0.9,1.0]
