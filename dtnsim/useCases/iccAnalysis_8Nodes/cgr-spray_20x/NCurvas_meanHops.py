...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"RandomNetwork_cgr1_20x/results/results_random/0.2/METRIC=appBundleReceivedHops:mean-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_cgr3_20x/results/results_random/0.2/METRIC=appBundleReceivedHops:mean-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_cgr_proactive_20x/results/results_random/0.2/METRIC=appBundleReceivedHops:mean-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_sprayAndWait_20x/results/results_random/0.2/METRIC=appBundleReceivedHops:mean-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_sprayAndWait_4copies_20x/results/results_random/0.2/METRIC=appBundleReceivedHops:mean-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_epidemic_20x/results/results_random/0.2/METRIC=appBundleReceivedHops:mean-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt"
]
