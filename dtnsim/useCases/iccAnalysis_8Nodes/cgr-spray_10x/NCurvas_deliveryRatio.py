...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"RandomNetwork_cgr1_10x/results/results_random/0.5/METRIC=deliveryRatio-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=280.txt",
"RandomNetwork_cgr3_10x/results/results_random/0.5/METRIC=deliveryRatio-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=280.txt",
"RandomNetwork_sprayAndWait_10x/results/results_random/0.5/METRIC=deliveryRatio-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=280.txt",
"RandomNetwork_sprayAndWait_3copies_10x/results/results_random/0.5/METRIC=deliveryRatio-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=280.txt",
"RandomNetwork_sprayAndWait_4copies_10x/results/results_random/0.5/METRIC=deliveryRatio-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=280.txt",
"RandomNetwork_epidemic_10x/results/results_random/0.5/METRIC=deliveryRatio-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=280.txt"
]
