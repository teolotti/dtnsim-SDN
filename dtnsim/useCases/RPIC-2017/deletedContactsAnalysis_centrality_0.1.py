...
OUTPUT_PATH = os.getcwd() + "/results/results_centrality/0.1"
        ...
        for density in DENSITY_RANGE:
            ...
            for aware in ["true", "false"]:
                ...
                for cp in CP_RANGE:
                    ...
                    f_avg_by_rep.append(receivedPacketAv("%s/dtnsim-CP=contactPlan#2f%1.1f#_%d,faultsAware=%s"%(INPUT_PATH, density, cp,aware),
