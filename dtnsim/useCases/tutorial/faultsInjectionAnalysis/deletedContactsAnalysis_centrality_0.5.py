            ...
            for aware in ["true", "false"]:
                ...
                for cp in CP_RANGE:
                    if aware == "false":
                        ...
                        f_avg_by_rep.append(receivedPacketAv("%s/example6a-CP=contactPlan#2f%1.1f#_%d,faultsAware=%s"%(INPUT_PATH, density, cp,aware),
                        ...
                        f_avg_by_rep.append(receivedPacketAv(
                            "%s/example6b-CP=contactPlan#2f%1.1f#_%d,faultsAware=%s" % (INPUT_PATH, density, cp, aware),
                            MAX_DELETED_CONTACTS,
                            AMOUNT_OF_REPETITIONS,
                            metric[0]))
