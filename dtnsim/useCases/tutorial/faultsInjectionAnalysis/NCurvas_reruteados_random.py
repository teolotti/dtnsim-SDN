...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/results_random/random_bundles_Re-Ruteados.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/results/results_random"
FILE_PATHS_C1 = ["0.5/METRIC=dtnBundleReRouted:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=1-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt"]

FILE_PATHS_C2 = ["0.5/METRIC=dtnBundleReRouted:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=1-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt"]
...
NAME_CURVAS_1 = ["$\delta = 0.5, Faults Aware$"]
NAME_CURVAS_2 = ["$\delta = 0.5, Non Faults Aware$"]
