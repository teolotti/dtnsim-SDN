...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results_Graphics/centrality_bundles_Re-Ruteados.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/results_Graphics/centrality/0.5"
FILE_PATHS_C1 = ["METRIC=dtnBundleReRouted:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=1-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt"]

FILE_PATHS_C2 = ["METRIC=dtnBundleReRouted:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=1-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt"]
