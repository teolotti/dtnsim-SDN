...
#OUTPUT
#
FILE_OUTPUT_PATH = os.getcwd() + "/results/results_random/meanBundlesInSDR.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/results/results_random"
FILE_PATHS_C1 = ["1.0/METRIC=sdrBundleStored:timeavg-DENSITY=1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=120.txt",
"0.5/METRIC=sdrBundleStored:timeavg-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt",
"0.1/METRIC=sdrBundleStored:timeavg-DENSITY=0.1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=10.txt"]

FILE_PATHS_C2 = ["1.0/METRIC=sdrBundleStored:timeavg-DENSITY=1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=120.txt",
"0.5/METRIC=sdrBundleStored:timeavg-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt",
"0.1/METRIC=sdrBundleStored:timeavg-DENSITY=0.1-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=10.txt"]
...
NAME_CURVAS_1 = ["$\delta = 1.0$","$\delta = 0.5$", "$\delta = 0.1$"]
...
def main():
    ...
    lines = []
    for c2,name2,color2,style2, in zip(c2s,NAME_CURVAS_2,COLOR_CURVAS_2,STYLE_CURVAS_2):
