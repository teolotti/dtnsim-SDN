...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = ["4Nodes_RandomNetwork_cgr1_10x/results/results_random/0.5/METRIC=appBundleReceivedHops:mean-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt"]

FILE_PATHS_C2 = ["4Nodes_RandomNetwork_sprayAndWait_10x/results/results_random/0.5/METRIC=appBundleReceivedHops:mean-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt"]
...
NAME_CURVAS_1 = ["$\delta = 0.5, CGR$"]
NAME_CURVAS_2 = ["$\delta = 0.5, SprayAndWait-2$"]

#Color of ploted functions
COLOR_CURVAS_1 = ['blue','blue','blue']
COLOR_CURVAS_2 = ['green','green','green']
