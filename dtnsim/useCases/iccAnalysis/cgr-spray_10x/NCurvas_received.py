...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = ["4Nodes_RandomNetwork_cgr1_10x/results/results_random/0.5/METRIC=appBundleReceived:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt"]

FILE_PATHS_C2 = ["4Nodes_RandomNetwork_sprayAndWait_10x/results/results_random/0.5/METRIC=appBundleReceived:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt"]
