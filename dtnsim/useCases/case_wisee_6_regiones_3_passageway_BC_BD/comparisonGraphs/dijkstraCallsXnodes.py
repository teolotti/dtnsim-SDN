...
#OUTPUT
FILE_OUTPUT_PATH = os.getcwd() + "/results/dijkstraCallsXnodes.pdf"

#INPUT. Complete path will be computed as DIRECTORY/FILE_PATHS_C1[i]
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"case1/results/METRIC=routeDijkstraCallsXnodes:sum.txt",
"case2/results/METRIC=routeDijkstraCallsXnodes:sum.txt",
]
...
NAME_CURVAS_1 = ["$CGR$","$IRR + CGR$"]

#Color of ploted functions
COLOR_CURVAS_1 = ['blue','green']

#Style of plotted function
STYLE_CURVAS_1 = ['--o','--s']

X_LABEL = "Bundles Sent"
Y_LABEL = "DijkstraCalls x Graph Nodes Ratio (IRR+CGR / CGR)"
