...
Y_LABEL = "Routing Computation Effort [s]"
...
def main():
    ...
    for i in zip(c1,c2,c3,c4,c5):
        c6.append((i[0][0],i[0][1] / 1e6 ))
        c7.append((i[0][0],i[1][1] / 1e6))
        c8.append((i[0][0],i[2][1] / 1e6))
        c9.append((i[0][0],i[3][1] / 1e6))
        c10.append((i[0][0],i[4][1] / 1e6))
