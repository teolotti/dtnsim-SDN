...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"case_wisee_4_regiones_1_passageway_BC_BD/case0/results/METRIC=appBundleReceivedHops:mean.txt",
"case_wisee_4_regiones_1_passageway_BC_BD/case1/results/METRIC=appBundleReceivedHops:mean.txt",
"case_wisee_4_regiones_1_passageway_BC_BD/case2/results/METRIC=appBundleReceivedHops:mean.txt",
"case_wisee_6_regiones_1_passageway_BC_BD/case1/results/METRIC=appBundleReceivedHops:mean.txt",
"case_wisee_6_regiones_1_passageway_BC_BD/case2/results/METRIC=appBundleReceivedHops:mean.txt",
]
