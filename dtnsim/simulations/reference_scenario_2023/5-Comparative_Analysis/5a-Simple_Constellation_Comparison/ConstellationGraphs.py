...
CONSTELLATION=["Star","Delta","Train"]
...
for constellation in CONSTELLATION:
    ...
    db=sqlite3.connect("%sGeneral-Routing=%s,Constellation=contactPlan#2f%s.txt,Size=%s-#0.sca"% (INPUT_PATH,ROUTING_REF,constellation,SIZE_REF))
...
for metric in METRICS : 
    ...
    for constellation in CONSTELLATION:
        ...
        plt.plot(X,f[j],"%s"%(FONT[j]),label="Constellation=%s"%(constellation))
        j=j+1
