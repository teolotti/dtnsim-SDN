...
for metric in METRICS : 
    ...
    #Browse the sizes to have a mean value for each one
        for size in SIZE:
            ...
            db=sqlite3.connect("%sGeneral-Routing=%s,Constellation=contactPlan#2f%s.txt,Size=%s-#0.sca"% (INPUT_PATH,ROUTING_REF,constellation,size))
...
pdf=PdfPages("Size-Constellation.pdf")
