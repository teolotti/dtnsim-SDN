...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"rrn_cgr1_1x/results/results_random/METRIC=appBundleReceivedHops:mean-FAULTAWARE=false-MAX_DELETED_CONTACTS=2788.txt",
"rrn_cgr3_1x/results/results_random/METRIC=appBundleReceivedHops:mean-FAULTAWARE=false-MAX_DELETED_CONTACTS=2788.txt",
"rrn_cgr_proactive_1x/results/results_random/METRIC=appBundleReceivedHops:mean-FAULTAWARE=false-MAX_DELETED_CONTACTS=2788.txt",
"rrn_sprayAndWait_1x/results/results_random/METRIC=appBundleReceivedHops:mean-FAULTAWARE=false-MAX_DELETED_CONTACTS=2788.txt",
"rrn_sprayAndWait_4copies_1x/results/results_random/METRIC=appBundleReceivedHops:mean-FAULTAWARE=false-MAX_DELETED_CONTACTS=2788.txt",
"rrn_epidemic_1x/results/results_random/METRIC=appBundleReceivedHops:mean-FAULTAWARE=false-MAX_DELETED_CONTACTS=2788.txt"
]
