...
"4Nodes_RandomNetwork_cgr3_10x/results/results_random/0.5/METRIC=dtnBundleSentToCom:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt",
"4Nodes_RandomNetwork_cgr3_10x/results/results_random/0.5/METRIC=dtnBundleSentToCom:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=true-MAX_DELETED_CONTACTS=60.txt",
...
"4Nodes_RandomNetwork_epidemic_10x/results/results_random/0.5/METRIC=dtnBundleSentToCom:count-DENSITY=0.5-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=60.txt"
]
