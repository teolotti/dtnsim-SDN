...
DIRECTORY = os.getcwd() + "/.."
FILE_PATHS_C1 = [
"RandomNetwork_cgr1_1x/results/results_random/0.2/METRIC=deliveryRatio-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_cgr3_1x/results/results_random/0.2/METRIC=deliveryRatio-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_cgr_proactive_1x/results/results_random/0.2/METRIC=deliveryRatio-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_sprayAndWait_1x/results/results_random/0.2/METRIC=deliveryRatio-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_sprayAndWait_4copies_1x/results/results_random/0.2/METRIC=deliveryRatio-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt",
"RandomNetwork_epidemic_1x/results/results_random/0.2/METRIC=deliveryRatio-DENSITY=0.2-AMOUNT_CONTACT_PLANS=10-FAULTAWARE=false-MAX_DELETED_CONTACTS=110.txt"
]
